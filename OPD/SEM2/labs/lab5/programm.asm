ORG     0x467 		; Адрес начала программы
res:   WORD 0x590 	; Ячейка для записи слова 
finish: WORD 0x00   	; Строки завершается по символу 00
temp:	WORD ?      	; Ячейка для записи нечетных символов
 

START:	CLA		    	; Очистка аккумулятора
s1:	IN 7			; Ожидание ввода нечетного символа
	AND #0x40	; Проверка на наличие введенного символа Бит 6 SR ==0 Готов нажата?
	BEQ s1	        ; Нет - "Спин-луп"
